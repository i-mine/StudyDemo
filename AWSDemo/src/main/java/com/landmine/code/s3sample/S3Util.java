...
public class S3Util {
    ...
    public static void download(AmazonS3 s3Client, String bucketName, String key, final String localPath){
        ...
        public static void downloadDir(AmazonS3 client, String bucket_name, String key_prefix,
    ...
    public static void downloadFile(AmazonS3 client, String bucket_name, String key_name,
    ...
    public static void main(String[] args) {
        ...
        if (s3_path_is_prefix) {
            downloadDir(client, bucket_name, key_name, local_path, false);
        } else {
            downloadFile(client, bucket_name, key_name, local_path, false);
        }
    }
}
